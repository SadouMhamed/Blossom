  ...
  return (
    ...
    >
        ...
        <div className="hero-container">
          ...
          <div className="hero-right green-bg">
            <div className="hero-content">
              ...
              >
                Découvrez comment Vestiaire Collective transforme l'industrie de
                la mode pour créer un impact positif sur la planète et la
                société.
              </motion.p>
      ...
      >
        <div className="stats-container white-bg">
          <div className="stats-header">
            <span className="stats-tag">PREVENTION IS BETTER THAN A CURE</span>
          ...
          <div className="stats-content">
            <div className="stats-text">
              <p>
                A well-known benefit of resale is that it prolongs the lifespan
                of an item, but that's not the only way to fight
              ...
              <p>
                ...
                instead of buying a new one, environmental impact is avoided. We
                call this our <strong>displacement rate</strong>.
            ...
            <div className="stats-visual">
              ...
              <div className="stats-description">
                <p>
                  <strong>of sold items replaced a first-hand purchase</strong>
                </p>
      ...
      <motion.nav className="bottom-navigation" variants={sectionVariants}>
        ...
        <button className="next-btn">Next Section →</button>
      </motion.nav>
    </motion.div>
  );
};
