...
import "./Section3Page.scss";

const Section3Page = ({ onBack }) => {
      ...
      >
        ...
        >
          ...
          <div className="header-center">
            <div className="logo-badge">
              ...
              <span className="year yellow">2024</span>
            </div>
          </div>
        ...
        <motion.section className="hero-section" variants={sectionVariants}>
          <div className="hero-container">
            ...
            <div className="hero-right yellow-bg">
              <div className="hero-content">
                ...
                >
                  Redefining the fashion industry through innovative
