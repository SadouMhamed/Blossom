...
import "./Section2Page.scss";

const Section2Page = ({ onBack }) => {
        ...
        >
          ...
          <div className="header-center">
            <div className="logo-badge">
              ...
              <span className="year pink">2024</span>
            </div>
          </div>
          ...
          <div className="hero-container">
            ...
            >
              <div className="hero-content">
                ...
                >
                  Driving transformative change across industries through
                  strategic communication and bold initiatives.
                </motion.p>
